  ...
  return (
    <main className="min-h-screen bg-white">
      {/* <LatestHero
        ...
        description="As Charlie Harris prepares to hand off his mission, who in the Toolmaking community will keep his spirit of tool-sharing alive?"
        ...
        imageAlt="Toolmaking machine at work"
      /> */}
